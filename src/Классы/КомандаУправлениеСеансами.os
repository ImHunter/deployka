...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Если мЭтоУправлениеРегламентнымиЗаданиями Или мЭтоУправлениеСеансами Тогда
		Парсер.ДобавитьПозиционныйПараметрКоманды(ОписаниеКоманды, "Действие", 
			...
			|Действие search предназначено для поиска активных сеансов. Например, может применяться для проверки того, что после блокировки, все реглаиенты завершили свою работу.
