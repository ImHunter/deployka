...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Если мЭтоУправлениеРегламентнымиЗаданиями Или мЭтоУправлениеСеансами Тогда
		Парсер.ДобавитьПозиционныйПараметрКоманды(ОписаниеКоманды, "Действие", 
			?(мЭтоУправлениеСеансами, "lock|unlock|kill|search
			...
			|Действие search предназначено для поиска активных сеансов. Например, может применяться для проверки того, что после блокировки, все регламенты завершили свою работу.
			|Если сеансы не найдены, то происходит завершение работы скрипта с ошибкой.", 
			"lock|unlock")
		);
	КонецЕсли;
